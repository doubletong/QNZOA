...
namespace SIGOA.Infrastructure
{
    public sealed class ImageHandler
    {
        ...
        //public static List<int> WithHeightByImg(string originalImagePath, int width, int height)
        //{
        ...
        //public static void BmpToJpeg(string filePatch, string outFilePatch)
        //{
        //    //FIBITMAP dib = FreeImage.Load(FREE_IMAGE_FORMAT.FIF_BMP, filePatch, FREE_IMAGE_LOAD_FLAGS.DEFAULT);
        //    //FIBITMAP dibResized = FreeImage.Rescale(dib, 1000, 1500, FREE_IMAGE_FILTER.FILTER_LANCZOS3);
        //    //FreeImage.Unload(dib);
        //    //FreeImage.Save(FREE_IMAGE_FORMAT.FIF_JPEG, dibResized, outFilePatch, FREE_IMAGE_SAVE_FLAGS.DEFAULT);
        //    //FreeImage.Unload(dibResized);

        //    using (Image<Rgba32> image = Image.Load(filePatch))
        //    {

        //        //image.Mutate(x => x
        //        //     .Resize(image.Width / 2, image.Height / 2)                    
        //        //     .Grayscale());
        //        image.Save(outFilePatch); // Automatic encoder selected based on extension.
        //    }
        //}
